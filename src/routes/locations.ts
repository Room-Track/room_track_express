...
router.delete('/', getQuerySpec('Locations'), async (req: Request, res) => {
...
router.post('/', getBodySpec('Locations'), async (req: Request, res) => {
	const client: CosmosClient = req.app.get('client');
...
router.get('/', getQuerySpec('Locations'), async (req: Request, res) => {
	const client: CosmosClient = req.app.get('client');
